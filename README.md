...
- [x] **Predictive Engine:** Implementing Linear Regression/LSTM to forecast next-day prices. ✅ *Completed*
- [x] **Alert System:** Email notifications for high-confidence bearish signals. ✅ *Completed*
